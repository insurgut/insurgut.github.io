Сделай чтоб сто процентов было процентов громкости на 100 или выбранное значение разными способами, так же не PNG а jpg  и чтоб закрыть нельзя было это окно
